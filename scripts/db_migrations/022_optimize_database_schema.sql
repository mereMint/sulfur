...
CALL add_index_if_not_exists('blackjack_games', 'idx_blackjack_user_date', 'user_id, created_at DESC');
CALL add_index_if_not_exists('roulette_games', 'idx_roulette_user_date', 'user_id, created_at DESC');
CALL add_index_if_not_exists('mines_games', 'idx_mines_user_date', 'user_id, created_at DESC');
