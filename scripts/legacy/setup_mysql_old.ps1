# ============================================================
# Sulfur Bot - MySQL Setup Helper for Windows (Legacy)
# ============================================================
# Archived legacy script. Prefer using the latest guides:
# - MYSQL_SETUP.md (Windows)
# - README.md / TERMUX_GUIDE.md (Termux/Linux)

Write-Host "============================================================" -ForegroundColor Cyan
Write-Host "         Sulfur Bot - MySQL Setup Helper (Legacy)          " -ForegroundColor Cyan
Write-Host "============================================================" -ForegroundColor Cyan
Write-Host ""

# Original legacy script content preserved below
