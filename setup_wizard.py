...
if not connected:
    ...
    if last_error and last_error.errno == 2003:
        ...
        print("    Start-Service -Name 'MySQL*' -ErrorAction SilentlyContinue")
        print("    # Service names vary by version (MySQL80, MySQL84, MariaDB, etc.)")
        print()
        print("  • Linux (systemd):")
        ...
        print("    # If first time, initialize the database:")
        print("    # mysql_install_db --user=$(whoami) --datadir=$PREFIX/var/lib/mysql")
